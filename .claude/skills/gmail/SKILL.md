...
allowed-tools: Bash(AIOS_DIR=* ~/.venv/bin/python3 ~/.config/gmail/gmail.py *)
---
...
```bash
AIOS_DIR="/opt/aios" ~/.venv/bin/python3 ~/.config/gmail/gmail.py list --all
```
...
```bash
AIOS_DIR="/opt/aios" ~/.venv/bin/python3 ~/.config/gmail/gmail.py list --hours 48
```

### Read full email

```bash
AIOS_DIR="/opt/aios" ~/.venv/bin/python3 ~/.config/gmail/gmail.py read <msg_id>
```

### Move email to label/folder

```bash
AIOS_DIR="/opt/aios" ~/.venv/bin/python3 ~/.config/gmail/gmail.py move <msg_id> "Label Name"
```
...
```bash
AIOS_DIR="/opt/aios" ~/.venv/bin/python3 ~/.config/gmail/gmail.py labels
```

### Reply to an email

```bash
AIOS_DIR="/opt/aios" ~/.venv/bin/python3 ~/.config/gmail/gmail.py reply <msg_id> "Your reply body here"
```
...
```bash
AIOS_DIR="/opt/aios" ~/.venv/bin/python3 ~/.config/gmail/gmail.py reply <msg_id> "Your reply body here" --attachments "/path/to/file1.pdf,/path/to/file2.png"
```

### Send a new email

```bash
AIOS_DIR="/opt/aios" ~/.venv/bin/python3 ~/.config/gmail/gmail.py send "to@example.com" "Subject here" "Body here"
```

### Send with attachments

```bash
AIOS_DIR="/opt/aios" ~/.venv/bin/python3 ~/.config/gmail/gmail.py send "to@example.com" "Subject" "Body" --attachments "/path/to/file.pdf"
```

### Create a Gmail filter (auto-sort rule)

```bash
AIOS_DIR="/opt/aios" ~/.venv/bin/python3 ~/.config/gmail/gmail.py filter --from "sender@example.com" --label "LabelName" --archive --read
```
...
```bash
AIOS_DIR="/opt/aios" ~/.venv/bin/python3 ~/.config/gmail/gmail.py filters
```

### Re-authenticate

```bash
AIOS_DIR="/opt/aios" ~/.venv/bin/python3 ~/.config/gmail/gmail.py auth
```
...
7. Save it to `~/.config/gmail/credentials.json`
